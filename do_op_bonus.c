...
/*   Updated: 2025/03/14 22:03:56 by zouazrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	put_moves(map);
	mlx_put_image_to_window(map->mlx, map->win, map->player.img[0], new.x * SIZE,
		new.y * SIZE);
	...
	mlx_put_image_to_window(map->mlx, map->win, map->empty.img[0], curr.x * SIZE,
		curr.y * SIZE);
